...
--Finding Who report whom
Select M.EmployeeName [Employee],E.EmployeeName [Report to (Manager)] 
from ReportingStructure E right join ReportingStructure M on E.EmployeeID=M.ManagerID